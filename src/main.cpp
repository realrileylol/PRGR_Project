...
int main(int argc, char *argv[]) {
    ...
    // NO DIGITAL ZOOM - Use full 320×240 sensor @ 240 FPS (OV9281 QVGA mode - maximum speed)
    // Ball ~17-20 px diameter (8-10 px radius)
    cameraCalibration.setCropParameters(0, 0, 320, 240);
